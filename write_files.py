...
def write_file_shared(filepath, content):
    ...
    if handle == INVALID_HANDLE_VALUE:
        ...
        print(f"FAILED: CreateFileW error {err}")
        return False
    
    written = wintypes.DWORD(0)
    result = WriteFile(handle, data, len(data), ctypes.byref(written), None)
    CloseHandle(handle)
    ...
    if result:
        ...
        print(f"FAILED: WriteFile error")
        return False

# File 1: Moog15Voice.cpp
moog15_content = r'''#include "Moog15Voice.h"
#include <cmath>
#include <algorithm>
...
# File 2: JX3PProcessor.cpp
jx3p_content = r'''#include "JX3PProcessor.h"
#include "JX3PVoice.h"
